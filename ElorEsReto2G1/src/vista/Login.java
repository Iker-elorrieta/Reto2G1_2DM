...
public class Login extends JFrame {
    ...
    public Login(Socket socket) {
        ...
        btnVer.setIcon(new ImageIcon("C:\\Users\\in2dm3-a\\eclipse-workspace\\ElorEsReto2G1\\media\\ojo.jpg"));
                	    ...
                	    public void actionPerformed(ActionEvent e) {
                	        ...
                	        try {
                	            ...
                	            if (codigo == 1) {
                	                ...
                	                JOptionPane.showMessageDialog(null, "Login Correcto", "Acceso Permitido", JOptionPane.INFORMATION_MESSAGE);
                	                ...
                	                JOptionPane.showMessageDialog(null, "Los alumnos no pueden iniciar sesión", "Acceso Denegado", JOptionPane.WARNING_MESSAGE);
