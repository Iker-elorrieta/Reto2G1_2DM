...
public class Perfil extends JFrame {
	...
	public Perfil(Users user) {
		...
		panelInformacion.add(crearCampo("ID", String.valueOf(user.getId()), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Email", user.getEmail(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Usuario", user.getUsername(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Nombre", user.getNombre(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Apellidos", user.getApellidos(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("DNI", user.getDni(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Dirección", user.getDireccion(), posicionVertical));
		posicionVertical += 55;
		panelInformacion.add(crearCampo("Teléfono 1", user.getTelefono1(), posicionVertical));
		posicionVertical += 55;
